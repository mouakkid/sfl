                ...
                <tr key={o.id} className="border-b hover:bg-gray-50">
                  ...
                  <Td className="text-right">
                    <div className="inline-flex items-center gap-2 pr-1">
                      ...
                      {/* ✅ Suppression via route POST (fiable sur Vercel) */}
                      <form action="/orders/delete" method="POST" className="inline">
                        <input type="hidden" name="id" value={o.id} />
                        <button type="submit" className="inline-flex items-center gap-1 px-2 py-1 border rounded text-red-600">
                          <TrashIcon /> Supprimer
                        </button>
                      </form>
                    </div>
...
function DownloadIcon(props: SVGProps<SVGSVGElement>) {
  return (<svg {...props} width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><path d="M7 10l5 5 5-5"/><path d="M12 15V3"/></svg>)
}
